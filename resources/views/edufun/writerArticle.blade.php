...
<body>
    ...
    <div class="row d-flex flex-row align-items-center pt-5 gap-3" style="padding-right: 10rem; padding-left: 10rem;">
        <div class="image-wrapper bg-info rounded-circle shadow" style="height:150px; width: 150px; display: flex; align-items: center; justify-content: center; ">               
            <img src="{{ $writer->writer_image }}" alt="Article Image" class="rounded-circle image-fluid " style="object-fit:cover; height: 120px; width: 120px">        
        </div>
        <div class="col">
            <p>{{$writer->name}}</p>
